function Settings = SegmentationSettings_HighThroughputDevice_v02(NoPlots)

%% Note the not all parameters are used for future calculation. Please see commentary in behavior segmentation functions for more details 
...
Settings.SmoothingInfo  = struct(  'InterpolationFactor',           0.1, ...              % 0.01 (smoother) or 0.1?? Interpolation factor for the path coordinates. For large arena @2Hz use InterpolationFactor = 0.9
...
Thresholds.StraightRun.MinVelocityAmplitude_ForRunDefinition        = 0.1; % mm/sec
Thresholds.StraightRun.MinVelocityAmplitude_ForInermediateVelocity  = 0.06; % mm/sec
...
PlotInfo_Default.PlotConfiguration = 2;                  
